...
use threecrate_io::{read_mesh, read_mesh_iter, read_point_cloud, read_point_cloud_iter};
...
fn benchmark_point_cloud(
    ...
    let memory_usage =
        std::mem::size_of_val(&cloud) + (cloud.len() * std::mem::size_of::<Point3f>());
    ...
    println!(
        "  Points/sec: {:.0}",
        point_count as f64 / full_load_time.as_secs_f64()
    );
    println!();
    ...
    println!(
        "  Points/sec: {:.0}",
        stream_point_count as f64 / streaming_time.as_secs_f64()
    );
    println!();
...
fn benchmark_mesh(file_path: &str, chunk_size: usize) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "  Faces/sec: {:.0}",
        face_count as f64 / full_load_time.as_secs_f64()
    );
    println!();
    ...
    println!(
        "  Faces/sec: {:.0}",
        stream_face_count as f64 / streaming_time.as_secs_f64()
    );
    println!();
